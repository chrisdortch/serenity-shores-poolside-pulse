(() => {
  const VERSION = '11';
  const TITLE = 'Serenity Shores Poolside Pulse Version 11';
  const DESCRIPTION = 'Serenity Shores Poolside Pulse Version 11: normal pool music, receiver command audio, weather safety holds, and the Weekly Poolside Party Command Page.';
