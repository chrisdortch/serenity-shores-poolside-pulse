(() => {
  ...
  function dispatchStatus() {
    try {
      window.dispatchEvent(new CustomEvent('poolside-v22-audio-status', { detail: status() }));
    } catch {}
  }
  ...
  window.__poolsideV22UnlockAudio = unlock;
  window.__poolsideV22AudioStatus = status;
  window.__poolsideV22PlayAnnouncementBlob = playBlob;
  window.__poolsideV22PlayAudioUrl = playAudioUrl;
  window.__poolsideV22PlayTestTone = playTestTone;
  window.__poolsideV22StopAudio = stopActiveAudio;
