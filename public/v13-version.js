(() => {
  const VERSION = '13';
  const TITLE = 'Lake123 - Poolside Pulse - Version 13';
  const DESCRIPTION = 'Lake123 - Poolside Pulse - Version 13: active receivers, command audio, weather safety holds, daily automation, music volume control, and weekly party schedules.';
