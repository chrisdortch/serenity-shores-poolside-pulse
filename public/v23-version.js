(() => {
  const VERSION = '23';
  const TITLE = 'Lake123 - Poolside Pulse - v23';
  const DESCRIPTION = 'Lake123 Poolside Pulse v23: command iPhones control the speaker-connected Home iPhone with a guaranteed quiet Suno/direct audio bed, loud spoken announcements, Spotify controls, and scheduled audio.';
