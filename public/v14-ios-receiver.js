(() => {
  ...
  function dispatchStatus() {
    try {
      const detail = status();
      window.dispatchEvent(new CustomEvent('poolside-v14-audio-status', { detail }));
  ...
  window.__poolsideV14UnlockAudio = unlock;
  window.__poolsideV14AudioStatus = status;
  window.__poolsideV14PlayAnnouncementBlob = playBlob;
  window.__poolsideV14PlayTestTone = playTestTone;
