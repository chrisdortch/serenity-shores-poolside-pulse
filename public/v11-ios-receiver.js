(() => {
  ...
  function dispatchStatus() {
    try {
      const detail = status();
      window.dispatchEvent(new CustomEvent('poolside-v11-audio-status', { detail }));
  ...
  window.__poolsideV11UnlockAudio = unlock;
  window.__poolsideV11AudioStatus = status;
  window.__poolsideV11PlayAnnouncementBlob = playBlob;
  window.__poolsideV11PlayTestTone = playTestTone;
