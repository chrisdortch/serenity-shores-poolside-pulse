(() => {
  const VERSION = '15';
  const TITLE = 'Lake123 - Poolside Pulse - Version 15';
  const DESCRIPTION = 'Lake123 - Poolside Pulse - Version 15: active receivers, command audio, weather safety holds, daily automation, music volume control, and weekly party schedules.';
