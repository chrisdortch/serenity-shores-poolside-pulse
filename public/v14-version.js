(() => {
  const VERSION = '14';
  const TITLE = 'Lake123 - Poolside Pulse - Version 14';
  const DESCRIPTION = 'Lake123 - Poolside Pulse - Version 14: active receivers, command audio, weather safety holds, daily automation, music volume control, and weekly party schedules.';
