(() => {
  ...
  function note(text) {
    try {
      ...
      if (box && receiverScreen && !box.innerHTML.includes(text)) box.innerHTML += '<br><b>V5.9 iPhone:</b> ' + text;
    } catch {}
  }
  ...
  function rewriteVersion() {
    try {
      document.title = 'Serenity Shores Poolside Pulse V5.9';
      const root = document.getElementById('app');
      if (root) root.dataset.version = '5.9';
      const walker = document.createTreeWalker(document.body, NodeFilter.SHOW_TEXT);
      const nodes = [];
      while (walker.nextNode()) nodes.push(walker.currentNode);
      nodes.forEach(n => {
        if (n.nodeValue) n.nodeValue = n.nodeValue
          .replaceAll('V5.0','V5.9').replaceAll('Version 5.0','Version 5.9')
          .replaceAll('V4.9','V5.9').replaceAll('Version 4.9','Version 5.9')
          .replaceAll('V4.8','V5.9').replaceAll('Version 4.8','Version 5.9')
          .replaceAll('V4.7','V5.9').replaceAll('Version 4.7','Version 5.9')
          .replaceAll('V4.6','V5.9').replaceAll('Version 4.6','Version 5.9')
          .replaceAll('V4.5','V5.9').replaceAll('Version 4.5','Version 5.9')
          .replaceAll('V4.4','V5.9').replaceAll('Version 4.4','Version 5.9')
          .replaceAll('V4.2','V5.9').replaceAll('Version 4.2','Version 5.9')
          .replaceAll('V4.0','V5.9').replaceAll('Version 4.0','Version 5.9');
      });
    } catch {}
  }
