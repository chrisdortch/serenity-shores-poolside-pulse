(() => {
  ...
  function dispatchStatus() {
    try {
      const detail = status();
      window.dispatchEvent(new CustomEvent('poolside-v15-audio-status', { detail }));
  ...
  window.__poolsideV15UnlockAudio = unlock;
  window.__poolsideV15AudioStatus = status;
  window.__poolsideV15PlayAnnouncementBlob = playBlob;
  window.__poolsideV15PlayTestTone = playTestTone;
