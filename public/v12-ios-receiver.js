(() => {
  ...
  function dispatchStatus() {
    try {
      const detail = status();
      window.dispatchEvent(new CustomEvent('poolside-v12-audio-status', { detail }));
  ...
  window.__poolsideV12UnlockAudio = unlock;
  window.__poolsideV12AudioStatus = status;
  window.__poolsideV12PlayAnnouncementBlob = playBlob;
  window.__poolsideV12PlayTestTone = playTestTone;
