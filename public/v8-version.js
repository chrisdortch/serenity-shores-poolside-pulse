(() => {
  const VERSION = '8.0';
  const TITLE = 'Serenity Shores Poolside Pulse V8';
  const DESCRIPTION = 'Serenity Shores Poolside Pulse V8: receiver-owned Spotify playback, durable command events, AI voice announcements, weather checks, and schedule control.';
