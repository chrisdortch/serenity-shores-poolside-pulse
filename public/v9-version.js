(() => {
  const VERSION = '9';
  const TITLE = 'Serenity Shores Poolside Pulse V9';
  const DESCRIPTION = 'Serenity Shores Poolside Pulse V9: pool-hours Spotify defaults, Suno command playback, voice or Suno announcements, weather safety holds, and multi-receiver command control.';
