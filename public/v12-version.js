(() => {
  const VERSION = '12';
  const TITLE = 'Lake123 - Poolside Pulse - Version 12';
  const DESCRIPTION = 'Lake123 - Poolside Pulse - Version 12: active receivers, command audio, weather safety holds, daily automation, and weekly party schedules.';
