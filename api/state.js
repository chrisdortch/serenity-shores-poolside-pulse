...
const V20_AUDIO_DEFAULTS_ID = '2026-07-01-v20-4-music15-voice1000-solid';
...
function sanitizeState(state) {
  ...
  if (clean[defaultsKey] !== defaultsId) {
    ...
    clean.announcementGain = version === '20' ? 10 : 5;
  ...
  clean.announcementGain = clampNumber(clean.announcementGain, 1, version === '20' ? 12 : 6, version === '20' ? 10 : 5);
  return clean;
}
