...
async function playAnnouncementBlob(blob) {
  if (typeof window.__poolsideV8PlayAnnouncementBlob === 'function') {
    return await window.__poolsideV8PlayAnnouncementBlob(blob, { gain: S.announcementGain });
  }
