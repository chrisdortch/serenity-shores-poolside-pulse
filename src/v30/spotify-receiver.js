...
const PKCE_TRANSACTION_KEY = 'poolside-pulse-v30-spotify-pkce';
const LEGACY_TOKEN_KEY = 'poolside-pulse-vfinal-spotify-token';
...
const PLAYER_NAME = 'Poolside Pulse v30 Receiver';
const DEFAULT_RETURN_PATH = '/?v=30#receiver';
...
function saveToken(data) {
  ...
  storageRemove(globalThis.localStorage, LEGACY_TOKEN_KEY);
  return token;
}
...
export class SpotifyReceiver {
  constructor({
    ...
    // v30 requests a broader, current scope set. Never leave the obsolete token
    // beside the replacement credential after this receiver takes over.
    storageRemove(globalThis.localStorage, LEGACY_TOKEN_KEY);
